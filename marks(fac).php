...
<div class="container">
  <h1><center> STUDENTS' MARKS SHEET </center></h1>

<form action="pdfgen.php">
  <div class="upbtn">
...
<table class="table table-hover">
  <thead>
    ...
    $q2="select s.s_name, s.usn from student s, student_course_info sc, lec_course lc where s.usn=sc.usn and sc.course_code='".$courseid."' and sc.course_code = lc.course_code and lc.l_id = '".$l_id."' and s.sem = lc.sem order by usn";  
     ...
     <tbody>
      ...
      <td>
      <div class="md-form">
        <input type="text" id="form1" class="form-control text-center" value="<?php echo $test1; ?>" readonly >
      ...
      <td>
      <div class="md-form">
        <input type="text" id="form1" class="form-control text-center" value="ABSENT" readonly >
          <label for="form1"></label>
      </div>
    </td>
    <?php }
      ...
      <td>
      <div class="md-form">
        <input type="text" id="form1" class="form-control text-center" name="test1[]" >
          <label for="form1"></label>
      </div>
    ...
    <?php 
     ...
     if ($test2 != '0' && $test2 != '') { ?>        
      <div class="md-form">
        <input type="text" id="form1" class="form-control text-center" value="<?php echo $test2; ?>" readonly >
          <label for="form1"></label>
      </div>
           <?php }
       else if ($test2 == '0') { ?>        
    ...
    <?php }
     ...
     ?>
      <div class="md-form">
        <input type="text" id="form2" class="form-control text-center" name="test2[]" >
 ...
 <td>  
    <?php 
     ...
     if ($test3 != '0' && $test3 != '') { ?>        
      <div class="md-form">
        <input type="text" id="form1" class="form-control text-center" value="<?php echo $test3; ?>" readonly >
          <label for="form1"></label>
      </div>
           <?php }
       else if ($test3 == '0') { ?>        
    ...
    <?php }
     ...
     ?>
      <div class="md-form">
        <input type="text" id="form2" class="form-control text-center" name="test3[]" >
          <label for="form2"></label>
      </div>
    ...
    <?php 
     ...
     if ($quiz1 != '0' && $quiz1 != '') { ?>        
      <div class="md-form">
        <input type="text" id="form1" class="form-control text-center" value="<?php echo $quiz1; ?>" readonly >
          <label for="form1"></label>
      </div>
           <?php }
       else if ($quiz1 == '0') { ?>        
    ...
    <?php }
      ...
      ?>
      <div class="md-form">
        <input type="text" id="form2" class="form-control text-center" name="quiz1[]" >
          <label for="form2"></label>
      </div>
    ...
    <?php 
     ...
     if ($quiz2 != '0' && $quiz2 != '') { ?>        
      <div class="md-form">
        <input type="text" id="form1" class="form-control text-center" value="<?php echo $quiz2; ?>" readonly >
          <label for="form1"></label>
      </div>
           <?php }
       else if ($quiz2 == '0') { ?>        
    ...
    <?php }
      ...
      ?>
      <div class="md-form">
        <input type="text" id="form2" class="form-control text-center" name="quiz2[]" >
          <label for="form2"></label>
      </div>
    ...
    <td>
     <?php 
      ...
      if ($test_1 != '' and $test_2 != '' and $test_3 != '' and $quiz_1 != '' and $quiz_2 != '') {
        ...
        if (($test_1 <= $MAX && $test_1 > $MIN && $test_1 >= $MIN))
          $SMAX = $test_1;
        else if (($test_2 <= $MAX && $test_2 > $MIN && $test_2 >= $MIN))
          $SMAX = $test_2;
        else 
          $SMAX = $test_3;
...
<table class="table table-hover">
 ...
 <td>  
    ...
    <?php 
     ...
     if ($lab1 != '0' && $lab1 != '') { ?>        
      <div class="md-form">
        <input type="text" id="form1" class="form-control text-center" value="<?php echo $lab1; ?>" readonly >
          <label for="form1"></label>
      </div>
           <?php }
       else if ($lab1 == '0') { ?>        
    ...
    <?php }
      ...
      ?>
      <div class="md-form">
        <input type="text" id="form2" class="form-control text-center" name="lab1[]" >
          <label for="form2"></label>
      </div>
      <input type="hidden" name="usn3[]" value="<?php echo $usn[$i]; ?>">
    </td> <?php } ?>    
    ...
    <?php 
     ...
     if ($lab2 != '0' && $lab2 != '') { ?>        
      <div class="md-form">
        <input type="text" id="form1" class="form-control text-center" value="<?php echo $lab2; ?>" readonly >
          <label for="form1"></label>
      </div>
           <?php }
       else if ($lab2 == '0') { ?>        
    ...
    <?php }
      ...
      ?>
      <div class="md-form">
        <input type="text" id="form2" class="form-control text-center" name="lab2[]" >
          <label for="form2"></label>
      </div>
...
<?php
    ...
    <?php }
      ...
      <div class="md-form">
        <input type="text" id="form1" class="form-control text-center" name="cie[]" >
          <label for="form1"></label>
      </div>
