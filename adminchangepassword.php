...
if(!isset($_SESSION['username'])){
 ...
 $username=$_SESSION['username'];
    ...
    if(isset($_POST['reset']))
    {
		...
		$qu1 = mysqli_query($conn, "select * from admin where admin_id='".$username."' and password='".$oldpass."'");
        ...
        else 
        {
           ...
           if(mysqli_num_rows($res) >= 1){
              $sql1="update admin set password = '".$password."' where admin_id='".$username."'";
...
<button class="glow-on-hover" onclick="location.href = 'adminprofile.php'" type="button">Back</button>
<br>
<div class="container">
 <section id="content">
   <form method="POST">
...
<br>             <!-- Material input -->
<div class="md-form">
  <input type="password" id="form1" class="form-control" name="pass" placeholder="Old password" required="">
  <label for="form1"></label>
</div>
<div class="md-form">
  <input type="password" id="form1" class="form-control" name="password" placeholder="New password" required="">
  <label for="form1"></label>
</div>
<div class="md-form">
  <input type="password" id="form1" class="form-control" name="cpassword" placeholder="Retype password" required="">
  <label for="form1"></label>
</div>
 <div>
