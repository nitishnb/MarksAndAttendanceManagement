...
<div class="container">
  <h1>MY COLLEAGUES</h1>
  <br><br>
  <button type="button" class="btn" onclick="window.location.href = 'deptview.php';">View my department colleagues</button> 
  <br><br><br>
  <?php 
  $qu = "SELECT l.l_id, l.l_name, l.phno FROM lecturer l where l.l_id != '".$username."' order by l.l_name";
