...
{
	$id=($_GET['del']);
	$adn="delete from student where usn=?";
...
<br>
<h2><b  style="color: green">Student Details</b></h2>
	...
	<table class="customer-table">
		...
		<tfoot>
			<tr>
				<td colspan="3">
					USN and Password can't be edited
				</td>
			</tr>
		</tfoot>
		<tbody>
<?php //code for read data from Database
	$ret = "select * from student order by usn";
...
<td><a href="studentedit.php?usn=<?php echo $row->usn;?>"><b>Edit</b></a>&emsp;|&emsp;<a href="sview.php?del=<?php echo $row->usn;?>"  onclick="return confirm('Are you sure?')"><b  style="color: red"> Delete</b></a></td>
</tr>
<?php $cnt=$cnt+1; } ?>
</tbody>
</table>
